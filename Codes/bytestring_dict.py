...
def bytestring_dict(symbol):
	...
	"""
	Dict_byte={"\xc9\x9b":'ɛ',"\xc9\x99":'ə',"\xc9\x94\xcc\x83":'ɔ̃',"\xc3\xb8":'ø',"\xca\x83":'ʃ',"\xca\x81":'ʁ',"\xc9\x91\xcc\x83":"ɑ̃","\xca\x92":'ʒ',"\xc5\x93\xcc\x83":'œ̃',"\xc9\x94":'ɔ',"\xc5\x93":'œ',"\xc9\xa1":'g',"\xc9\x9b\xcc\x83":'ɛ̃',"\xcb\x90":'ː'}
